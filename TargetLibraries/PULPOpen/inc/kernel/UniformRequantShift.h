...
void UniformRequantShift_u8_u8(uint8_t *data_in, int32_t size, int32_t mul,
                               int32_t add, uint8_t *data_out, int32_t log2D,
                               int32_t HW, int32_t input_offset,
                               int32_t output_offset, uint8_t output_min,
                               uint8_t output_max, bool rounding);

void UniformRequantShift_s16_u8(int16_t *data_in, int32_t size, int32_t mul,
                                int32_t add, uint8_t *data_out, int32_t log2D,
                                int32_t HW, int32_t input_offset,
                                int32_t output_offset, uint8_t output_min,
                                uint8_t output_max, bool rounding);

void UniformRequantShift_s32_u8(int32_t *data_in, int32_t size, int32_t mul,
                                int32_t add, uint8_t *data_out, int32_t log2D,
                                int32_t HW, int32_t input_offset,
                                int32_t output_offset, uint8_t output_min,
                                uint8_t output_max, bool rounding);
